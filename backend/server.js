...
// ============================================================================
//
// Your existing database collection is "user".
// We intentionally do not create a new users collection.
//
...
server.listen(
  ...
  () => {
    ...
    console.log(
      `Resource API ready at /api/resources`
    )

    console.log(
      `Asset API ready at /api/assets`
    )
  }
)